...
export function matchTransformer(
    ...
    return {
        ...
        tournament_gender: input.tournament_gender,
        stage_name: input.stage_name,
        match_date: input.match_date,
        match_time: input.match_time,
        home_team_score: input.home_team_score,
        away_team_score: input.away_team_score,
        home_team_score_penalties: input.home_team_score_penalties,
        away_team_score_penalties: input.away_team_score_penalties,
        score: input.score,
